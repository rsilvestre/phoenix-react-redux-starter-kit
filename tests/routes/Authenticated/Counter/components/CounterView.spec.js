...
import { Counter } from 'routes/Authenticated/Counter/components/Counter'
  ...
  beforeEach(() => {
    ...
    _props = {
      ...
      ...bindActionCreators({
        ...
        connectToChannel: (_spies.connectToChannel = sinon.spy()),
        leaveChannel: (_spies.leaveChannel = sinon.spy())
