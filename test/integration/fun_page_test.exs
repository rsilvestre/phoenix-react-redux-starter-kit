defmodule PhoenixReactReduxStarterKit.FunPageTest do
  ...
  test "Should render the page properly" do
    ...
    assert attribute_value(find_element(:xpath, "//*[@id='root']/div/div/div[2]/div/div/div/div/input"), "value")
      == ""
  ...
  test "Should change the text in the jumbotron area" do
    ...
    inputFieldElement = find_element(:xpath, "//*[@id='root']/div/div/div[2]/div/div/div/div/input")
