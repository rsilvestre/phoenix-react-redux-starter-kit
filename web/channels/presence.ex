defmodule PhoenixReactReduxStarterKit.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PhoenixReactReduxStarterKit.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :phoenix_react_redux_starter_kit,
                        pubsub_server: PhoenixReactReduxStarterKit.PubSub
end
